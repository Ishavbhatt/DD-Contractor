...
function Footer() {
  return (
    <footer className="relative bg-ftr-bg lg:py-10 lg:px-28 px-5 py-10">
          ...
          <div className="w-full lg:w-6/12">
            ...
            },
            {
              ...
              <div className="w-full lg:w-4/12 px-4">
                ...
                <div className="">
          <a href="https://www.facebook.com/" target="blank" className="pr-2 hover:opacity-75"><Image src="/icons/facebook.png" width={35} height={35} /></a>
          <a href="https://www.instagram.com/" target="blank" className=" hover:opacity-75"><Image src="/icons/instagram.png" width={35} height={35} /></a>
          </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="text-sm text-gray-600 font-semibold py-1">
              © Mud House Contractor, All Right Reserved.
            </div>
          </div>
        </div>
      </div>
